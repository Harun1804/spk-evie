                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Data Dasar</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="{{route('datadasar.kriteria')}}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Kriteria dan Alternatif</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="{{route('datadasar.matriks')}}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Matriks</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                ...
                                <li>
                                    <a href="{{route('analisa.index')}}">
                                        ...
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Hasil Analisa</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('normalisasi.index')}}">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Normalisasi</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{route('hasil_akhir.index')}}">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>D</b></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.main">Hasil Akhir</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                            </ul>
